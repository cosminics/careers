...
function LivIconsEvoDefaults () {
	...
	var defaultOptions = {
		...
		pathToFolder: 'http://localhost/carrers/wp-content/themes/ics_careers/assets/liviconsevo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
	...
	if (defaultOptions.pathToFolder === 'http://localhost/carrers/wp-content/themes/ics_careers/assets/liviconsevo/svg/') {
